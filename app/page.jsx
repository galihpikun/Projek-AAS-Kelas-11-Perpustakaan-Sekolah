...
export default function Home() {
  return (
    <main className="flex flex-col gap-20 scroll-smooth">
      <nav className="flex justify-around items-center h-18 bg-[#3665DD]  text-white w-full fixed z-10">
        ...
        <div className="flex gap-5">
          ...
          <Link href="/signup" className="px-6 rounded-md py-1 font-semibold bg-[#393E46]">Signup</Link>
        </div>
      </nav>

      <section className="flex flex-col items-center justify-center mt-30 text-white" id="home">
        <div className="bg-linear-65 from-purple-500 to-pink-500 h-[400px] w-11/12 rounded-xl flex items-center justify-center text-center p-20 gap-25">
      ...
      <section id="about" className="flex justify-around items-center gap-10 p-20 ">
        <div className="flex flex-col gap-3">
          <h3 className="rounded-full bg-[#3665DD] w-fit px-3 py-1 text-lg font-medium text-white">About us</h3>
      ...
      <section className="flex flex-col items-center gap-10 px-20" id="features">
        <h1 className="text-xl font-semibold rounded-full bg-[#3665DD] w-fit px-5 py-2 text-white">Our Features</h1>
        <div className="flex items-center justify-center gap-10">
          <div className="w-[400px] h-auto rounded-2xl flex flex-col gap-2 hover:scale-105 transition-transform duration-300 shadow-2xl">
      ...
      <footer>
        <div className="bg-[#3665DD] w-full h-20 flex justify-center items-center">
